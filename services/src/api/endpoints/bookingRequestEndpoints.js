const bookingRequestEndpoints = {
  ...
  getBookingRequestsByStatus: (status) =>
    `/booking-requests?populate[0]=status&populate[1]=admin_comment&populate[2]=name&populate[3]=age&populate[4]=gender&populate[5]=email&populate[6]=phone_number&populate[7]=occupation&populate[8]=recommendation_letter&populate[9]=notifications&populate[10]=guest_house&populate[11]=guests&populate[12]=accommodation_requirements&populate[13]=room_allocations.room&sort[0]=createdAt:desc&filters[status][$eq]=${status}`, // GET booking requests based on status
