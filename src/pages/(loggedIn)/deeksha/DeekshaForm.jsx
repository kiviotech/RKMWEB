    ...
    <div className="deekshaform-container">
      ...
      <div className="deekshaform-prefix-container">
        ...
        <div className="deekshaform-checkbox-container">
          {[ 'Smt','Sri', 'Kumar', 'Kumari']
            .filter((option) => {


              if (!gender) return ['Sri', 'Smt', 'Kumar', 'Kumari'].includes(option);
              if (gender === 'Male') return ['Sri', 'Kumar'].includes(option); // Male-specific options
      ...
      <div className="deekshaform-button-container">
        <Link className="deekshaform-footer-button" to="/deekshaAdress-form">
          Next
        </Link>
      </div>
    </div>
