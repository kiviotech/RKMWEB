    ...
    <div className="donation-status">
      ...
      <div className="status-container">
        ...
        <div className="donation-details">
          <p>
            <span className="dot donated"></span> Donated <strong>{donatedGuests}/{totalGuests}</strong>
          </p>
          <p>
            <span className="dot yet-to-donate"></span> Yet to donate <strong>{yetToDonate}/{totalGuests}</strong>
          </p>
        </div>
      ...
      <a href="/donationdetail" className="view-more">View more &gt;</a>
    </div>
  );
};
