...
import { createNewDonation, fetchDonationById, updateDonationById } from '../../../../services/src/services/donationsService';
import { useAuthStore } from '../../../../store/authStore';
import { createNewGuestDetails, fetchGuestDetails } from '../../../../services/src/services/guestDetailsService';
...
const ViewDonation = () => {
    ...
    const prepareConsentLetterData = () => {
        return {
            uniqueDonorId: currentReceipt?.uniqueDonorId || '',
            donationDate: getCurrentFormattedDate(),
            amount: currentReceipt?.donationDetails?.amount,
            transactionType:
        ...
        <body>
          <div class="consent-letter">
            ...
            <p style="margin-top: 5px;">
              ...
              by ${donationData.transactionType} as ${donationData.donationType
            ...
            <div style="margin-top: 5px;">
              <p style="margin: 0;">${donorDetails.title} ${donorDetails.name
            }</p>
        ...
        <body>
          <div class="thank-letter">
            ...
            <div class="donor-address">
              ...
              <p>${donationData.houseNumber
                ? `Vill: ${donationData.houseNumber}`
                : ""
            }${donationData.streetName ? `, ${donationData.streetName}` : ""
            }</p>
              <p>${donationData.postOffice ? `PO: ${donationData.postOffice}` : ""
            }${donationData.district ? `, Dist: ${donationData.district}` : ""
            }</p>
              <p>${donationData.state ? `State: ${donationData.state}` : ""}${donationData.pincode ? `, Pin: ${donationData.pincode}` : ""
            }</p>
            </div>
            ...
            <div class="acknowledgment">
              <p>We, thankfully acknowledge your kind and generous contribution of Rs. ${donationData.amount
            }/- (${numberToWords(donationData.amount)} only) ${donationData.transactionType
                ? `by ${donationData.transactionType.toLowerCase()}`
                : ""
            } ${donationData.donationType ? `as ${donationData.donationType}` : ""} ${donationData.purpose
                ? `for ${donationData.purpose === "Other"
          ...
          <div class="receipt-reference">
            <p>Please find attached herewith the official Receipt vide no. (${donationData.receiptNumber
            }, dated ${formatDate(
                donationData.donationDate
          ...
          <div style="border: 1px solid #000; text-align: center;">
            <span>Please Mention Your Id (${donationData.uniqueDonorId
            ...
            <div className="tab-section">
                ...
                >
                    ...
                    >
                        <div className="tabs">
                            <button
                                className={`tab ${selectedTab === "Math" ? "active" : ""} ${donationData?.status === "completed" &&
                            ...
                            <button
                                className={`tab ${selectedTab === "Mission" ? "active" : ""} ${donationData?.status === "completed" &&
            ...
            <div className="main-content">
                <div className="donor-section">
                    ...
                    >
                        ...
                        >
                            <h2>Donor Details</h2>
                            <div className="unique-id-display">{currentReceipt.uniqueDonorId}</div>
                        </div>
